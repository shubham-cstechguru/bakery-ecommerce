<template lang="html">
  <div class="location">
    <section
      class="location_add_view"
      >
      <b-container>
          <AdminHeading pageTitle="Location" />
        <b-row>
          <b-col
            md="5"
            xs="12"
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        'selected',
        { key: 'shopname', label: 'Shop Name', sortable: true, sortDirection: 'desc', class: 'text-left ml-1' },
        { key: 'location', label: 'Location', sortable: true, class: 'text-left ml-1' },
