<template lang="html">
  <div class="country">
    <section class="country">
      <b-container fluid>
        <AdminHeading pageTitle="Country" />
        <b-row>
          <b-col md="4" xs="12">
            <b-card>
              <b-form>
                  ...
                  <b-form-group
                    ...
                    <b-form-group
                      ...
                      <b-form-file
                        ...
                        :state="Boolean(file1)"
                        placeholder="Choose a Country Map or drop it here..."
                        drop-placeholder="Drop Country Map here..."
                        ></b-form-file>
                    </b-form-group>
...
export default {
  ...
  data() {
    return {
      ...
      countries: [{text: 'Select One', value: null}, 'INDIA', 'USA'],
      show: true,
      datas: [
        {country: 'INDIA'}
      ],
      fields: [
        'selected',
        { key: 'country', label: 'Country', sortable: true, sortDirection: 'desc', class: 'text-left ml-1' },
