                      ...
                      >
                                    ...
                                    <b-form-group
                                      ...
                                      <b-form-input
                                        ...
                                        placeholder="Enter Area Short Name"
                                        required
                                        >
                                      </b-form-input>
                                    </b-form-group>
...
export default {
  ...
  data() {
    return {
      ...
      states: [{text: 'Select State', value: null}, 'Rajasthan', 'Karnataka'],
      citys: [{text: 'Select City', value: null}, 'Jodhpur', 'Udaipur'],
      show: true,
      datas: [
        {area: 'Pungal Para'}
      ],
      fields: [
        ...
        { key: 'area', label: 'Area', sortable: true, sortDirection: 'desc', class: 'text-left ml-1' },
